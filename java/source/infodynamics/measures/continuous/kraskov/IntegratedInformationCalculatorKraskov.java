 ...
 * stationary distribution following Barrett and Seth (2011), using the
 * non-parametric estimators of Kraskov et al.
 * </p>
 *  
 * <p><b>References:</b><br/>
 * <ul>
...
public class IntegratedInformationCalculatorKraskov
   ...
   * Constructor.
   */
  public IntegratedInformationCalculatorKraskov() {
    super();
    PARTITION_SCAN_METHOD = "BIPARTITION";
    baseCalculator = new EffectiveInformationCalculatorKraskov();
  }

...
public class EffectiveInformationCalculatorKraskov
  ...
  protected NearestNeighbourSearcher[] rangeSearchersInMarginalsPast = null;
  protected NearestNeighbourSearcher[] rangeSearchersInMarginalsFutr = null;

  /**
   * Constructor.
   */
  public EffectiveInformationCalculatorKraskov() {
    super();
  }

  @Override
  public void initialise(int dims, int tau) throws Exception {
    rangeSearchersInMarginalsPast = null;
  ...
  protected void ensureMarginalSearchersConstructed(List<List<Integer>> partition) throws Exception {
    ...
    rangeSearchersInMarginalsPast = new NearestNeighbourSearcher[nb_parts];
    ...
    for (int i = 0; i < nb_parts; i++) {
      ...
      rangeSearchersInMarginalsPast[i] = NearestNeighbourSearcher.create(pastPartData);
  ...
  protected double[] partialComputeFromObservationsParts(int startTimePoint,
    ...
    for (int t = startTimePoint; t < startTimePoint + numTimePoints; t++) {
      ...
      // Count the number of points whose x distance is less than eps
      double sumF = 0.0;
      ...
      sumF += (MathsUtils.digamma(n_sys + 1) - digammaN);
      ...
      for (int i = 0; i < nb_parts; i++) {
        ...
        int n = rangeSearchersInMarginalsPast[i].countPointsStrictlyWithinR(
                  t, eps, dynCorrExclTime);
        ...
        sumF -= (MathsUtils.digamma(n + 1) - digammaN);

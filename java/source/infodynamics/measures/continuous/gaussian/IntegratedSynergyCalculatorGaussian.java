 ...
 * {@see infodynamics.measures.continuous.gaussian.EffectiveSynergyCalculatorGaussian}
 * </p>
 *
 * <p><b>References:</b><br/>
 * <ul>
 ...
 */
public class IntegratedSynergyCalculatorGaussian
    extends IntegratedMeasureCalculatorGaussian {

  /**
   * Constructor.
   */
  public IntegratedSynergyCalculatorGaussian() throws Exception {
    super();
    PARTITION_SCAN_METHOD = "BIPARTITION";
    baseCalculator = new EffectiveSynergyCalculatorGaussian();
  }

  @Override
  public double computeNormalizationFactor(List<List<Integer>> p) throws Exception {
    return 1.0;
  }
